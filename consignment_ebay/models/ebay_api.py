...
class EbayAPI(models.AbstractModel):
    ...
    def get_oauth_url(self):
        ...
        callback_url = f"{base_url}/ebay/oauth/callback"
        # eBay requires the RuName as redirect_uri in the OAuth URL
        redirect_uri = config.ru_name if config.ru_name else callback_url
